...
class Application
{
    ...
    private function loadConfig($configFile){
        ...
        return json_decode( // преобразование json строки
            file_get_contents($configFile),// чтение содержимого файла, результат json строка
    ...
    public function handleRequest(Request $request){
        ...
        $db = DBConnection::getInstance(); // создание и получение ссылки объекта DBConnection
        $db->initConnection($this->config['db']); // установка соединения с БД
